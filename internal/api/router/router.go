...
func SetupRouter(cfg *RouterConfig) *gin.Engine {
	...
	userActivityService := service.NewUserActivityService(userActivityRepo, cfg.Logger)
	...
	eventService := service.NewEventService(eventRepo, userActivityService, cfg.Logger)
	ticketService := service.NewTicketService(ticketRepo, eventRepo, userActivityService, cfg.Logger)
